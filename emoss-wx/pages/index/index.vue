 ...
 <template>
 	<view class="page">
 		<swiper circular="true" interval="5000" duration="1000" class="swiper">
 			<swiper-item>
 				<image mode="widthFix" src="https://emoss110013-1306902317.cos.ap-beijing.myqcloud.com/img/banner/swiper-1.jpg"></image>
 			</swiper-item>
 			<swiper-item>
 				<image mode="widthFix" src="https://emoss110013-1306902317.cos.ap-beijing.myqcloud.com/img/banner/swiper-2.jpg"></image>
 			</swiper-item>
 			<swiper-item>
 				<image mode="widthFix" src="https://emoss110013-1306902317.cos.ap-beijing.myqcloud.com/img/banner/swiper-3.jpg"></image>
 			</swiper-item>
 			<swiper-item>
 				<image mode="widthFix" src="https://emoss110013-1306902317.cos.ap-beijing.myqcloud.com/img/banner/swiper-4.jpg"></image>
 			</swiper-item>
 			<swiper-item>
 				<image mode="widthFix" src="https://emoss110013-1306902317.cos.ap-beijing.myqcloud.com/img/banner/swiper-5.jpg"></image>
 			</swiper-item>
 		</swiper>
	...
	export default {
		...
		methods: {
			toPage:function(name,url){
				...
				if(!flag){//为了测试拍照功能，把！flag改成flag了。应该是后期工作流需要修改。
					uni.showToast({
						icon:"none",
						title:"您不具备相关权限"
					})
